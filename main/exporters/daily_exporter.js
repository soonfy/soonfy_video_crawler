...
const dailer = (film_id, start, end) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        if (!film) {
            ...
            if (film.show_type === 2) {
                ...
                if (films.length > 0) {
                    let promises = sites.map((site) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        for (let _film of films) {
                            ...
                            if (!fp) {
                                ...
                                _plays = yield c_film_plist_playcount_1.CFilmPlistPlayCount.find({ film_plist_id: fp._id, date: { $gte: start, $lte: end } });
                            }
                    ...
                    let plays = yield Promise.all(promises);
